# Mon projet fil rouge se nomme Pokétools.

 Pour le réaliser, j'ai utilisé Tailwind en tant que framework CSS.
...
## Pour le TP.
- Je me suis concentrée sur le codex. Celui-ci fait un appel API afin de retourner le sprite des Pokémon, leurs noms, leurs types, leurs ID ainsi que leurs descriptions. La prochaine étape sera de créer une page complète pour chaque Pokémon.